...
void init_gl()
{
	...
	{
 		texture_type=GL_UNSIGNED_BYTE;//texture_type= GL_UNSIGNED_SHORT_5_6_5_REV;
	}
	else
	{
	...
	if (!nRotateGame)
	{
	    ...
	    glOrthof(0, nGamesWidth, nGamesHeight, 0, -1,1);
	}
	else
	{
		glRotatef(90.0, 0.0, 0.0, 1.0);
	 	glOrthof(0, nGamesHeight, nGamesWidth, 0, -1,5);
	}
...
void TexToQuad()
{
	...
	fbaprintf("222");
	glTexCoordPointer(2, GL_FIXED, 0, gTexCoods);
	fbaprintf("333");
