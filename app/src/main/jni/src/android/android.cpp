...
extern "C"
{
	void Java_org_libsdl_app_SDLActivity_nativeInitWithArgs(JNIEnv* env, jclass cls, jobjectArray strArray);
	void Java_org_libsdl_app_SDLActivity_setfskip( JNIEnv *env, jobject thiz, jint n );
	void Java_org_libsdl_app_SDLActivity_emustop( JNIEnv *env, jobject thiz );
	jint Java_org_libsdl_app_SDLActivity_ispaused( JNIEnv *env, jobject thiz );
	void Java_org_libsdl_app_SDLActivity_pauseemu( JNIEnv *env, jobject thiz );
	void Java_org_libsdl_app_SDLActivity_resumeemu( JNIEnv *env, jobject thiz );
	jint Java_org_libsdl_app_SDLActivity_getslotnum( JNIEnv *env, jobject thiz );
	void Java_org_libsdl_app_SDLActivity_statesave( JNIEnv *env, jobject thiz, jint statenum );
	void Java_org_libsdl_app_SDLActivity_stateload( JNIEnv *env, jobject thiz, jint statenum );
	void Java_org_libsdl_app_SDLActivity_setPadData( JNIEnv *env, jobject thiz, jint i, jlong jl );
}
